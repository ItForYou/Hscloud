...
public class TransactionService extends Service implements Observer {
     ...
     * Used as extra key in notification intents broadcasted by the TransactionService
     * when a Transaction is completed (TRANSACTION_COMPLETED_ACTION intents).
     * Allowed values for this key are any valid content uri_path.
     */
    public static final String STATE_URI = "uri_path";
...
//            }
                        ...
                        switch (transactionType) {
                            ...
                            default:
                                ...
                                // FIXME: We use the same startId for all MMs.
                                    Log.v(TAG, "onNewIntent: launchTransaction uri_path=" + uri);
    ...
    private static boolean isTransientFailure(int type) {
        return type > 0 && type < 10; // return type > MmsSms.NO_ERROR && type < MmsSms.ERR_TYPE_GENERIC_PERMANENT;
    }
...
//                            MessagingNotification.updateDownloadFailedNotification(this);
    ...
    protected void endMmsConnectivity() {
        try {
            ...
            if (mConnMgr != null && Build.VERSION.SDK_INT < 23 /*Build.VERSION_CODES.M*/) {
            ...
            if (mmsNetworkInfo == null) {
                ...
                if (mmsNetworkInfo.isConnected()) {
                    ...
                    if (TextUtils.isEmpty(settings.getMmscUrl())) {
                        ...
                        sendBroadcast(new Intent(com.victor.android.send_message.Transaction.MMS_ERROR));
