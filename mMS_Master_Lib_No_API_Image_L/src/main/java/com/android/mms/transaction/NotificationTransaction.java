            ...
            if (retrieveConfData != null) {
                ...
                if ((pdu == null) || (pdu.getMessageType() != MESSAGE_TYPE_RETRIEVE_CONF)) {
                    ...
                    Uri uri = p.persist(pdu, Uri.parse("content://mms/inbox"), true,
                            com.victor.android.send_message.Transaction.mSettings.getGroup(), null);
                    ...
                    mContext.sendBroadcast(new Intent(com.victor.android.send_message.Transaction.NOTIFY_OF_MMS));
                }
            }
