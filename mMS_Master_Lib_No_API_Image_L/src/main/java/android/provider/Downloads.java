...
public final class Downloads {
    ...
    public static final class Impl implements BaseColumns {
         ...
         * download's content: uri_path is specified in the intent's data.
         */
         ...
         * associated with that download. The download's content: uri_path is specified
         ...
         */
        public static final String COLUMN_URI = "uri_path";
